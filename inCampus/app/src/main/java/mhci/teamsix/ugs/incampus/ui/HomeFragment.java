...
import mhci.teamsix.ugs.incampus.asynctask.AllShopAsyncTask;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progBar = (ProgressBar) view.findViewById(R.id.progbar_home);
        ...
        swipey = (SwipeRefreshLayout) view.findViewById(R.id.swipe_refresh_fragment_home);
    ...
    public void callAsync(){
        AllShopAsyncTask shopAsyncTask = new AllShopAsyncTask(HomeFragment.this);
