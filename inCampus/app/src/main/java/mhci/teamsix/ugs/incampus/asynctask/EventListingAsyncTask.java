...
import mhci.teamsix.ugs.incampus.ui.EventAvailableActivity;
...
public class EventListingAsyncTask extends AsyncTask<Void, Void, String> {
    private EventAvailableActivity eventActivity;
    final ProgressBar progBar;
    public EventListingAsyncTask(EventAvailableActivity parent){
        eventActivity = parent;
        progBar =  (ProgressBar) eventActivity.findViewById(R.id.progbar_event_avail);
    }


    @Override
    protected String doInBackground(Void... params) {
        String url = "http://ugsteamsix.esy.es/query.php?bid=0";
