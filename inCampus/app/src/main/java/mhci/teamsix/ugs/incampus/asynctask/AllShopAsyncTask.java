...
import mhci.teamsix.ugs.incampus.ui.HomeFragment;
...
public class AllShopAsyncTask extends AsyncTask<Void, Void, String> {
    private HomeFragment homeFragment;

    public AllShopAsyncTask(HomeFragment homeFragment){
    ...
    protected void onPostExecute(String results){
        ...
        try {
            ...
            foodStoreList.add(new ForStaticDataToTest().getFoodStore());
            homeFragment.onItemsLoadComplete(foodStoreList);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
