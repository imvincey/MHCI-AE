...
public class SouthShopAsyncTask extends AsyncTask <Void, Void, String> {
    private SouthFragment southFragment;

    public SouthShopAsyncTask(SouthFragment southFragment){
        this.southFragment = southFragment;
    }
    ...
    protected void onPostExecute(String results){
        ...
        try {
            ...
            southFragment.onItemsLoadComplete(foodStoreList);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
