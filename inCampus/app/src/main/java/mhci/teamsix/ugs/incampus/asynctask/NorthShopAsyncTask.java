...
public class NorthShopAsyncTask extends AsyncTask<Void, Void, String> {
    private NorthFragment northFragment;


    public NorthShopAsyncTask (NorthFragment northFragment){
        this.northFragment = northFragment;
    }
    @Override
    ...
    protected void onPostExecute(String results){
        ...
        try {
            ...
            northFragment.onItemsLoadComplete(foodStoreList);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
