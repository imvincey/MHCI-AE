...
import mhci.teamsix.ugs.incampus.asynctask.SouthShopAsyncTask;
...
public class SouthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progBar = (ProgressBar) view.findViewById(R.id.progbar_south);

        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_south);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getContext(), 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new CardSpaceItemDeco(2, dpToPx(10), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        swipey = (SwipeRefreshLayout) view.findViewById(R.id.swipe_refresh_fragment_south);
    ...
    public void callAsync(){
        SouthShopAsyncTask async = new SouthShopAsyncTask(this);
        async.execute();
    }
